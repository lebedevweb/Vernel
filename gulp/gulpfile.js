...
gulp.task('styles', () => {
  ...
  .pipe(gulp.dest('../build/custom/vernal/css'))
  .pipe(browserSync.stream());
});
...
gulp.task('scripts', () => {
  return gulp.src(scriptFiles)
    // .pipe(sourcemaps.init())
      ...
      .pipe(sourcemaps.write())
    .pipe(gulp.dest('../build/custom/vernal/js'))
    .pipe(browserSync.stream());
});
...
gulp.task('images', function(){
  return gulp.src('../src/images/**/*.{png,jpg}')
    .pipe(gulp.dest('../build/custom/vernal/images'))
    .pipe(cwebp())
    .pipe(gulp.dest('../build/custom/vernal/images'))
});
...
gulp.task('fonts', function(){
  return gulp.src('../src/fonts/**/*.{woff,woff2,ttf,otf}')
    .pipe(gulp.dest('../build/custom/vernal/fonts'))
});
